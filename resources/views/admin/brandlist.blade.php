          ...
          <div class="col-12">
            <div class="card">
              <div class="card-header">
                <h3 class="card-title">Brand's List</h3>
              ...
              <!-- /.card-header -->
              <div class="card-body">
                <table id="brand-table" class="table table-bordered table-hover data-table">
                <thead>
                    <tr>  
                        <th>Brand Name</th>
                        <th>Parent Name</th>
...
var brandroute="{{ route('brands') }}";
var saveBrandRoute="{{ route('saveBrandRoute')}}";
var DeleteRoute="{{ route('deletethecompany')}}";
var UpDateCompany="{{ route('UpDateCompany')}}";
</script>